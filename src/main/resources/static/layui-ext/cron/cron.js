...
layui.define(["form"], function (exports) {
  ...
  Class.prototype.render = function () {
    ...
    var elemFooter = [
      ...
      '<div class="cron-box"><div class="cron-footer-btns"><span lay-type="run" class="cron-btns-run">运行</span><span lay-type="confirm" class="cron-btns-confirm">確定</span></div></div>',
    ];
  ...
  Class.prototype.getMinutesElem = function () {
    ...
    elem.push(
      ...
      val[2],
      '"/>',
      '<div class="cron-input-mid">分開始，每</div><input class="cron-input" type="number" name="perVal" value="',
      val[3],
      '"/>',
      '<div class="cron-input-mid">分執行一次</div><span class="cron-tips">(0/60)</span></div>',
  ...
  Class.prototype.getHoursElem = function () {
    ...
    elem.push(
      '<div><input type="radio" name="type[2]" value="all" title="每小時" ',
      radio[0],
      "></div>",
  ...
  Class.prototype.getDaysElem = function () {
    ...
    elem.push(
      ...
      '<div><input type="radio" name="type[3]" value="last" title="本月最後一日" ',
      radio[5],
      "></div>",
  ...
  Class.prototype.getMonthsElem = function () {
    ...
    elem.push(
      '<div><input type="radio" name="type[4]" value="all" title="每個月" ',
      radio[0],
      "></div>",
  ...
  Class.prototype.getWeeksElem = function () {
    ...
    elem.push(
      '<div><input type="radio" name="type[5]" value="all" title="每周" ',
      radio[0],
      "></div>",
      ...
      '<div><input type="radio" name="type[5]" value="last" title="本月最後一個星期" ',
      radio[4],
            ...
            $.post(
              ...
              function (res) {
                if (res.code == 0) {
                  ...
                  layer.alert(res.msg, { icon: 2, title: "錯誤" });
                }
              },
              "json"
            );
